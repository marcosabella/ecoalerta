...
function PlatformPanel({ section, notify }) {
  ...
  const createUser = async event => {
    ...
    try {
      ...
      const { data: userId, error: finalizeError } = await supabase.rpc('platform_finalize_user', { target_email: userForm.email, target_full_name: userForm.full_name, new_role: userForm.role, target_municipality: municipalityId });
